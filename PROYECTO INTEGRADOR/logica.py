...
class logicap:
    ...
    def conexionBD(self):
        ...
        try:
            conexion= sqlite3.connect("C:/Users/ALAN777/Documents/GitHub/POOS181.1/POO2PARCIAL/PROYECTO INTEGRADOR/PROYECTO INTEGRADOR.db")
    ...
    def registraentrada (self,nom3,area2,serie,can3,fecha):
       ...
       if(area2 == ""):
           messagebox.showwarning("aviso","falto ingresar el dato Area")
       if(serie == ""):
           messagebox.showwarning("aviso","falto ingresar el dato Noº serie")
       if(can3 == ""):
           messagebox.showwarning("aviso","falto ingresar el dato Cantidad")   
       if(fecha == ""):
    ...
    def mactualizarclientes(self,id,nombre,producto,cantidad):
        if (id=="" and nombre=="" and producto=="" and cantidad==""):
            messagebox.showwarning("Cuidado","No se ingreso un dato, volver a ingresar los datos solicitados")   
        elif(id == ""):
            messagebox.showwarning("Cuidado","El ID no se encuentra en la base de datos")
        elif(nombre == ""):
            messagebox.showwarning("Cuidado","El Dato Nombre esta vacio, ingresar un dato")
        elif(producto == ""):
            messagebox.showwarning("Cuidado","El Dato Producto esta vacio, ingresar un dato")
        elif(cantidad == ""):
            messagebox.showwarning("Cuidado","El Dato Cantidad esta vacio, ingresar un dato")
        else:
            try:
    ...
    def mactualizarempleados(self,id,nombre,area,puesto):
        if(id == "" and nombre=="" and area=="" and puesto==""):
            messagebox.showwarning("Cuidado","No se pueden actualizar campos vacios volver a ingresar datos")
        elif(id == ""):
            messagebox.showwarning("Cuidado","El ID no se encuentra en la base de datos")
        elif(nombre == ""):
            messagebox.showwarning("Cuidado","El Dato Nombre esta vacio, ingresar un dato")
        elif(area == ""):
            messagebox.showwarning("Cuidado","El Dato Area esta vacio, ingresar un dato")
        elif(puesto == ""):
            messagebox.showwarning("Cuidado","El Dato Puesto esta vacio, ingresar un dato")
    ...
    def Actualizar_Entradas(self,id,nombre,area,serie,cantidad,fecha):
        if(id == "" and nombre=="" and area=="" and serie=="" and cantidad=="" and fecha==""):
            messagebox.showwarning("Cuidado","No se pueden actualizar campos vacios volver a ingresar datos")
        elif(id == ""):
            messagebox.showwarning("Cuidado","El campo ID no se ingreso algun dato")
        elif(nombre == ""):
            messagebox.showwarning("Cuidado","El campo Nombre no se ingreso algun dato")
        elif(area == ""):
            messagebox.showwarning("Cuidado","El campo Area no se ingreso algun dato")
        elif(serie == ""):
            messagebox.showwarning("Cuidado","El campo Noº de Serie no se ingreso algun dato")
        elif(cantidad == ""):
            messagebox.showwarning("Cuidado","La campo Cantidad no se ingreso algun dato")
        elif(fecha == ""):
            messagebox.showwarning("Cuidado","La campo fecha no se ingreso algun dato")
