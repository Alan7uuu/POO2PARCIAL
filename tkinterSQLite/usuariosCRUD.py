...
col=('id','Nombre', 'Correo','Contraseña')
a=ttk.Treeview(pestaña3,col=col ,show='headings' ,height=20)
a.heading('id', text='ID',anchor=CENTER)
a.heading('Nombre',text='Nombre',anchor=CENTER)
a.heading('Correo',text='Correo',anchor=CENTER)
a.heading('Contraseña', text='Contraseña',anchor=CENTER)
